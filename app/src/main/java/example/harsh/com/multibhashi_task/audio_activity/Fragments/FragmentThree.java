 ...
 */
public class FragmentThree extends Fragment implements MediaPlayer.OnPreparedListener{
    ...
    private FragmentThree.OnFragmentInteractionListener mListener;
    ...
    public void onStart() {
        ...
        try {
            mediaPlayer.setDataSource(getContext(), Uri.parse(Environment.getExternalStorageDirectory().getAbsolutePath()+
                    File.separator + "voices" + File.separator + "multibhashiAudio3.aac"));
        } catch (IOException e) {
            e.printStackTrace();
        }
