 ...
 */
public class FragmentFour extends Fragment implements MediaPlayer.OnPreparedListener{
    ...
    private FragmentFour.OnFragmentInteractionListener mListener;
    ...
    public void onStart() {
        ...
        try {
            mediaPlayer.setDataSource(getContext(), Uri.parse(Environment.getExternalStorageDirectory().getAbsolutePath()+
                    File.separator + "voices" + File.separator+ "multibhashiAudio4.aac"));
        } catch (IOException e) {
            e.printStackTrace();
        }
